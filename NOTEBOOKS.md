...
relevant structural properties, and only then reproduces the Mpemba crossing.
...
| 9 | [`asymm_ex5.ipynb`](asymm_ex5.ipynb) | Sec. III G 2, Fig. 11 | Exact-size SU(2) state-vector data and exact non-Abelian twirl |
...
100-realization manuscript average.
