...
| 8 | [`asymm_ex4.1.a.ipynb`](asymm_ex4.1.a.ipynb) | Sec. III G 1, Fig. 10 | Full 100-circuit exact-size ensemble, crossings, and information backflow |
...
| 11 | [`Mpemba_nonstatioinarity.ipynb`](Mpemba_nonstatioinarity.ipynb) | Appendix A, Fig. S1; published Fig. 14 | Nonstationary Mpemba relaxation in the driven collective-spin model |
| 12 | [`Mpemba_ETH.ipynb`](Mpemba_ETH.ipynb) | Appendix B, Fig. S2; published Fig. 15 | Thermal Mpemba crossing generated by an \(N=15\) ETH spin-chain bath |
| 13 | [`Mpemba_QFI_monotone.ipynb`](Mpemba_QFI_monotone.ipynb) | Appendix D, Fig. S3; published Appendix F, Fig. 17 | Monotone-dependent QFI crossings: SLD and WY cross, HM does not |
...
- [`Mpemba_nonstatioinarity.ipynb`](Mpemba_nonstatioinarity.ipynb) constructs
...
- [`Mpemba_ETH.ipynb`](Mpemba_ETH.ipynb) keeps the manuscript \(N=15\) bath,
...
- [`Mpemba_QFI_monotone.ipynb`](Mpemba_QFI_monotone.ipynb) is an exact,
